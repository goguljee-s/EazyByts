    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            if ($result1) {
                ...
                // $mg = Mailgun::create('e66f2b42da83211c2853ed5716f4770a-f68a26c9-b3b492e9');
                ...
                // // Compose email content
                // $htmlContent = '<p>Click the following link to verify your email address:</p>';
                // $htmlContent .= '<a href="https://yourdomain.com/Front%20End/verified.php?token=' . $verificationToken . '">Verify Email</a>';

                // // Send email
                // $result = $mg->messages()->send('sandbox812d71f1d79340fba61a6e7a81b2eb2e.mailgun.org', [
                //     'from' => 'GOGUL S <gogulkanan143@gmail.com>',
                //     'to' => $email,
                //     'subject' => 'Email Verification',
                //     'html' => $htmlContent
                // ]);
